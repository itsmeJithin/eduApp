        ...
        <div class="row row-same-height">
            <div class="col-md-5 b-r b-dashed b-grey ">
                <div class="padding-30 sm-padding-5 sm-m-t-15 m-t-50">
                    ...
                    <p class="small hint-text" v-if="!isFromExam">
                        Click on the <code class="text-success">Manage Questions</code> to create, update or delete
                        questions against each subjects
                    </p>
                    <p class="small hint-text" v-else>
                        Click on the <code class="text-success">Manage Exams</code> to create, update or delete
                        exams against each subjects
                    </p>
                </div>
            </div>
...
import ListClassGroupSubjects from "./ListClassGroupSubjects";

export default {
    name: "FilterSubjects",
    components: {ListClassGroupSubjects},
    props: {
        isFromExam: {
            default: false,
            type: Boolean
